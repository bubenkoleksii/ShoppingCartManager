...
{
    Task<Either<Error, ProductListResponse>> Get(
        int skip,
        int take,
        CancellationToken cancellationToken = default
    );
    Task<Either<Error, ProductResponse>> GetById(
        Guid id,
        CancellationToken cancellationToken = default
    );
    Task<Either<Error, ProductResponse>> Create(
        CreateProductRequest request,
        CancellationToken cancellationToken = default
    );
    Task<Either<Error, ProductResponse>> Update(
