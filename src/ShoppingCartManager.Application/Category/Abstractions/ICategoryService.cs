...
public interface ICategoryService
{
    ...
    Task<Either<Error, Category>> Create(CreateCategoryRequest request, CancellationToken cancellationToken = default);
    Task<Either<Error, Category>> Update(UpdateCategoryRequest request, CancellationToken cancellationToken = default);
